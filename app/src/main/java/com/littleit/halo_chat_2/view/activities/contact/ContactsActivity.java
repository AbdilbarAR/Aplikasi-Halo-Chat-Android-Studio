package com.littleit.halo_chat_2.view.activities.contact;
...
import com.littleit.halo_chat_2.Adapter.ContactsAdapter;
import com.littleit.halo_chat_2.Model.user.Users;
import com.littleit.halo_chat_2.R;
import com.littleit.halo_chat_2.databinding.ActivityContactsBinding;
        ...
        switch (requestCode) {
            case REQUEST_READ_CONTACTS: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    mobileArray = getAllPhoneContacts();
                    // Setelah izin diberikan, Anda dapat melakukan operasi yang diperlukan di sini.
                    // Sebagai contoh, Anda dapat memanggil metode getContactList()
                    getContactList();
                } else {
                    // Izin ditolak, Anda dapat menangani ini sesuai kebutuhan aplikasi Anda.
                    // Misalnya, memberikan pesan kepada pengguna atau menutup aktivitas.
                    finish();
                }
                return;
            }
